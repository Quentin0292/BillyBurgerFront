      ...
      <div id="contact" style={{ marginTop: `110px`, padding: `50px 80px` }}>
        <div className="contact-info">
          <div className="info">
            ...
            <p>
              Want to book a table ? You can book for any number of people at
              any time. Please use the form below to get in touch. Remember to
              tell us data, time and for how many people you'd like to book. For
              the same day bookins please call the restaurant directly as we
              can't guarantee an immediate reply. Thank you!
            </p>
          </div>
          <div className="form">
            <form action="#">
